        ...
        public override void GameUpdate () {
            ...
            while (launchProgress >= 1f) {
                if (AcquireTarget(out TargetPoint target)) {
                    ...
                    launchProgress = 0.999f; //to prevent infinite loop
                }
            }
        }
...
//                Debug.DrawLine(prev, next, Color.blue, shotsPerSecond - 0.1f);
//                prev = next;
//            }
//            
//            Debug.DrawLine(launchPoint, targetPoint, Color.yellow, shotsPerSecond - 0.1f);
//            Debug.DrawLine(
